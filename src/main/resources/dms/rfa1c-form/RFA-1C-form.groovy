...
[
  ...
  "DATE OF BIRTH OF CHILDRow1": dateIsoToUs(jsonMap.identified_children[0]?.date_of_birth),
  ...
  "DATE OF PLACEMENTRow1": dateIsoToUs(jsonMap.identified_children[0]?.date_of_placement),
  ...
  "DATE OF BIRTH OF CHILDRow2": dateIsoToUs(jsonMap.identified_children[1]?.date_of_birth),
  ...
  "DATE OF PLACEMENTRow2": dateIsoToUs(jsonMap.identified_children[1]?.date_of_placement),
  ...
  "DATE OF BIRTH OF CHILDRow3": dateIsoToUs(jsonMap.identified_children[2]?.date_of_birth),
  ...
  "DATE OF PLACEMENTRow3": dateIsoToUs(jsonMap.identified_children[2]?.date_of_placement),
  ...
  "DATE OF BIRTH OF CHILDRow4": dateIsoToUs(jsonMap.identified_children[3]?.date_of_birth),
  ...
  "DATE OF PLACEMENTRow4": dateIsoToUs(jsonMap.identified_children[3]?.date_of_placement),
