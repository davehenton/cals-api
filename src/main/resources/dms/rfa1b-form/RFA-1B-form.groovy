...
def offenseData = sliceData(getSafeJoinWith(". ", jsonMap.convicted_in_california_disclosures?.getAt(0)?.offense), [100, 130, 130] as int[])
def offenseDetailsData = sliceData(getSafeJoinWith(". ", jsonMap.convicted_in_california_disclosures?.getAt(0)?.offense_details), [60, *([130]*12)] as int[])
[
