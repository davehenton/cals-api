...
[
        ...
        'If yes name of Agencys_pg 3' : getSafeJoinWith.call(", ", jsonMap.adoption_history?.foster_care_licenses_q1?.agencies.collect{return it.name} as String[]),
        'Type of license/certification/approval_pg 3' : getSafeJoinWith.call(", ", jsonMap.adoption_history?.applications_for_adoption_q2?.agencies.collect{return it.type?.value} as String[]),
        'If yes name of Agencys_2_pg 3' : getSafeJoinWith.call(", ", jsonMap.adoption_history?.facility_operation_licenses_q3?.agencies.collect{return it.name} as String[]),
        'If yes type of license_pg 3' : getSafeJoinWith.call(", ", jsonMap.adoption_history?.facility_operation_licenses_q3?.agencies.collect{return it.type?.value} as String[]),
