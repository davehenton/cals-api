...
[
        ...
        'CITY AND COUNTY WHERE SIGNED Row1_pg 4' : jsonMap.applicants_declaration?.applicant_signatures?.getAt(0)?.with{return getSafeJoinWith.call(", ", signature_city, signature_county?.value)},
        'CITY AND COUNTY WHERE SIGNED Row2_pg 4' : jsonMap.applicants_declaration?.applicant_signatures?.getAt(1)?.with{return getSafeJoinWith.call(", ", signature_city, signature_county?.value)},
