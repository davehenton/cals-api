...
import gov.ca.cwds.cals.util.NullFriendlyTextBuilder;
...
public class AddressDTO extends BaseDTO {
  ...
  public static String buildFullAddressText(AddressDTO addressDTO) {
    return new NullFriendlyTextBuilder().buildText(addressDTO.getStreetAddress(),
