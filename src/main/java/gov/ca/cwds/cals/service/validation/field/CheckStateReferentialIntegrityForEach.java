...
@Retention(RUNTIME)
@Constraint(validatedBy = StateReferentialIntegrityForEachValidator.class)
@Documented
public @interface CheckStateReferentialIntegrityForEach {
  ...
  @interface List {
    ...
    CheckStateReferentialIntegrityForEach[] value();
  }
}
