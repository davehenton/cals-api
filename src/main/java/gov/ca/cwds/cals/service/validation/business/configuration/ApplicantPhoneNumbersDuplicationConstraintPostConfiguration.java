 ...
 */
public class ApplicantPhoneNumbersDuplicationConstraintPostConfiguration
    implements BusinessValidationConfiguration<ApplicantDTO> {

  public static final ApplicantPhoneNumbersDuplicationConstraintPostConfiguration INSTANCE =
      new ApplicantPhoneNumbersDuplicationConstraintPostConfiguration();

  private ApplicantPhoneNumbersDuplicationConstraintPostConfiguration() {
  }
