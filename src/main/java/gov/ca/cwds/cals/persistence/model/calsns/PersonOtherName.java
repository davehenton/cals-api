...
public class PersonOtherName implements Serializable {
    ...
    public PersonOtherName createUserId(String createUserId) {
    ...
    public PersonOtherName createDateTime(ZonedDateTime createDateTime) {
    ...
    public PersonOtherName updateUserId(String updateUserId) {
    ...
    public PersonOtherName updateDateTime(ZonedDateTime updateDateTime) {
