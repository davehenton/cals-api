...
import static gov.ca.cwds.cals.persistence.model.calsns.dictionaries.NameType.NAMED_QUERY_FIND_ALL;
...
@NamedQuery(name = NAMED_QUERY_FIND_ALL, query = "FROM NameType ORDER BY id ASC")
@Entity
