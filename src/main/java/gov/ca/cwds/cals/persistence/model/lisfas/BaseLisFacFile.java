...
/**
 * This base class is extracted for Jobs support.
 * Created by Alexander Serbin on 4/5/2018.
 */
@SuppressWarnings("squid:S3437") //LocalDate is serializable
@MappedSuperclass
public class BaseLisFacFile implements PersistentObject {
  ...
  private Integer facilityTypeCode;
  private Integer facilityStatusCode;
  private Integer facilityLastVisitReasonCode;
  ...
  private Integer facilityLastDeferredVisitReasonCode;
  ...
  public Integer getFacilityTypeCode() {
    return facilityTypeCode;
  }

  public void setFacilityTypeCode(Integer facilityTypeCode) {
    this.facilityTypeCode = facilityTypeCode;
  }

  @Basic
  @Column(name = "fac_status")
  public Integer getFacilityStatusCode() {
    return facilityStatusCode;
  }

  public void setFacilityStatusCode(Integer facilityStatusCode) {
    this.facilityStatusCode = facilityStatusCode;
  }

  @Basic
  @Column(name = "fac_last_visit_reason")
  public Integer getFacilityLastVisitReasonCode() {
    return facilityLastVisitReasonCode;
  }

  public void setFacilityLastVisitReasonCode(Integer facilityLastVisitReasonCode) {
    this.facilityLastVisitReasonCode = facilityLastVisitReasonCode;
  }
  ...
  public Integer getFacilityLastDeferredVisitReasonCode() {
    return facilityLastDeferredVisitReasonCode;
  }

  public void setFacilityLastDeferredVisitReasonCode(Integer facilityLastDeferredVisitReasonCode) {
    this.facilityLastDeferredVisitReasonCode = facilityLastDeferredVisitReasonCode;
  }
  ...
  @Transient
  public LisTableFile getCounty() {
    return county;
  }

  public void setFacilityStatus(LisTableFile facilityStatus) {
    this.facilityStatus = facilityStatus;
  }

  @Transient
  public LisTableFile getFacilityStatus() {
