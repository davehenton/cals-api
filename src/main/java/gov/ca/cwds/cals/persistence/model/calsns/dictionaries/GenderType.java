...
import static gov.ca.cwds.cals.persistence.model.calsns.dictionaries.GenderType.NAMED_QUERY_FIND_ALL;
...
@NamedQuery(name = NAMED_QUERY_FIND_ALL, query = "FROM GenderType ORDER BY id ASC")
@Entity
