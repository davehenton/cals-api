...
public class RequestExecutionContextFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    if (request instanceof HttpServletRequest) {
      ...
      try {
        Object requestStartTimeParameter = RequestExecutionContext.instance().get(Parameter.REQUEST_START_TIME);
        String requestStartTime = new SimpleDateFormat("yyyy-MM-dd-HH.mm.ss.SSS").format(requestStartTimeParameter);
