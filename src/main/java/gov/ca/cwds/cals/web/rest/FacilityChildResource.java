...
public class FacilityChildResource {
    ...
    public Response getChildren(@PathParam(FACILITY_ID) @ApiParam(required = true, name = FACILITY_ID,
        ...
        return collectionResourceDelegate.get(new FacilityChildParameterObject(facilityParameterObjectBuilder.createFacilityParameterObject(facilityNumber)));
    }
    ...
    public Response getChild(@PathParam(FACILITY_ID) @ApiParam(required = true, name = FACILITY_ID,
        ...
        return resourceDelegate.get(new FacilityChildParameterObject(facilityParameterObjectBuilder.createFacilityParameterObject(facilityNumber), childId));
    }
}
