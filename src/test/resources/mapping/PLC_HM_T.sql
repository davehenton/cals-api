...
(
    ...
    PRM_CNCTNM char(35) DEFAULT ' ' NOT NULL,
    PRM_EXT_NO int DEFAULT 0 NOT NULL,
    PRM_SUBSID char(10) DEFAULT 'NULL',
    PRM_SUBSNM char(54) DEFAULT ' ' NOT NULL,
    PRM_TEL_NO decimal(10) DEFAULT 0 NOT NULL,
    PVD_TRNSCD char(1) NOT NULL,
    PUB_TRNSCD char(1) NOT NULL,
    F_STATE_C smallint DEFAULT 0 NOT NULL,
    ...
    ARCASS_IND char(1) DEFAULT 'N' NOT NULL,
    COMFAC_IND char(1) DEFAULT 'N' NOT NULL,
    TRNHSG_IND char(1) DEFAULT 'N' NOT NULL,
    TRNHSG_FAC char(1) DEFAULT 'N' NOT NULL,
    NEWLIC_NO char(9) DEFAULT 'NULL',
    NEWLIC_UPD char(1) DEFAULT 'N' NOT NULL,
    OLDFAC_ID char(10) DEFAULT 'NULL',
    EM_CNT_B char(1) DEFAULT 'N' NOT NULL,
